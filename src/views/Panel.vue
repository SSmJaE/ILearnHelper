<template>
  <div v-show="!store.collapse" id="container-panel">
    ...
    <div id="container-control">
      ...
      <Button
        label="Github"
        onclick="window.open('https://github.com/SSmJaE/ILearnHelper','_blank')"
        title="本项目的仓库"
      ></Button>
...
export default class Panel extends Vue {
  ...
  test() {
    ...
    addMessage(
      [
        "扩展已是最新版本",
        '如果本项目帮助到了你，可以为本项目点一个<a href="https://github.com/SSmJaE/ILearnHelper" target="_blank"><u>star</u></a>',
        "可以前往交流群获取使用支持",
      ],
      "info"
    );
